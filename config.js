...
module.exports = {
  botname: process.env.BotName || "Yung", 
  author: process.env.Author || "@YUNG",
  packname: process.env.PackName || "YUNG MD",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© YUNG Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "YUNG",
  ownernumber: process.env.Owner_Number || "2349050053820",
